/*
=====================
Load Bronze Layer as Stored Procedure
=====================

This scripts creates a stored procedure that truncates and loads data into bronze layer.
After first run, the script can be run with
