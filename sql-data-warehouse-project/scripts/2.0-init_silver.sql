...
Build Silver Layer
=======================
This script create tables in the Silver layer with additional dwh_create_date metadata column.

WARNING: Running this script will drop the tables if they already exist.
*/
